...
INSERT INTO locations (code, name, name_with_type, type, parent_code, path_with_type) VALUES
                                                                                          ('01', 'Hà Nội', 'Thành phố Hà Nội', 'PROVINCE', NULL, 'Thành phố Hà Nội'),
                                                                                          ('79', 'Hồ Chí Minh', 'Thành phố Hồ Chí Minh', 'PROVINCE', NULL, 'Thành phố Hồ Chí Minh');

-- Dữ liệu Xã (WARD) trỏ thẳng về Tỉnh
INSERT INTO locations (code, name, name_with_type, type, parent_code, path_with_type) VALUES
                                                                                          ('00001', 'Dịch Vọng Hậu', 'Phường Dịch Vọng Hậu', 'WARD', '01', 'Phường Dịch Vọng Hậu, Thành phố Hà Nội'),
...
INSERT INTO validation_rules (entity_name, field_name, regex_pattern, error_message) VALUES
                                                                                         ('ORGANIZATION', 'email', '^[A-Za-z0-9+_.-]+@(.+)$', 'Định dạng Email không hợp lệ'),
                                                                                         ...
                                                                                         ('ORGANIZATION', 'website', '^(https?://)?([\\da-z.-]+)\\.([a-z.]{2,6})([/\\w .-]*)*/?$', 'Website không đúng định dạng'),
...
-- Dữ liệu Mapping mẫu
INSERT INTO data_mappings (source_system, entity_type, local_field, global_field) VALUES
                                                                                      ('CRM_SYSTEM', 'ORGANIZATION', 'Company_Name', 'legal_name'),
                                                                                      ('CRM_SYSTEM', 'ORGANIZATION', 'Tax_ID', 'tax_code');

-- Dữ liệu Tổ chức mẫu
INSERT INTO organizations (tax_code, legal_name, short_name, status) VALUES
                                                                         ('0100100123', 'Ngân hàng Thương mại Cổ phần Ngoại thương Việt Nam', 'Vietcombank', 'ACTIVE'),
...
INSERT INTO addresses (house_number, street, ward_code, province_code, full_address) VALUES
                                                                                         ('198', 'Trần Quang Khải', '40001', '79', '198 Trần Quang Khải, Phường Bến Nghé, Thành phố Hồ Chí Minh'),
                                                                                         ('01', 'Giang Văn Minh', '00001', '01', '01 Giang Văn Minh, Phường Dịch Vọng Hậu, Thành phố Hà Nội'),
                                                                                         ('Số 1', 'Duy Tân', '00001', '01', 'Số 1 Duy Tân, Phường Dịch Vọng Hậu, Thành phố Hà Nội'),
                                                                                         ('72', 'Lê Thánh Tôn', '40001', '79', '72 Lê Thánh Tôn, Phường Bến Nghé, Thành phố Hồ Chí Minh'),
                                                                                         ('54A', 'Nguyễn Chí Thanh', '00001', '01', '54A Nguyễn Chí Thanh, Thành phố Hà Nội');